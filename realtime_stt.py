...
# 설정
# ─────────────────────────────────────────
# API_KEY         = os.getenv("OPENAI_API_KEY", "여기에_API_KEY_입력")
...
SILENCE_THRESHOLD = 0.01        # 볼륨 임계값 (이 이하 = 무음)
MIN_SPEECH_DURATION = 0.5       # 최소 발화 길이 (초) - 너무 짧은 노이즈 제거
...
class RealtimeSTT:
    ...
    def start(self):
        ...
        print("=" * 50)
        print("  실시간 STT 시작")
        print(f"  언어: {LANGUAGE} | 무음 감지: {SILENCE_DURATION}초")
